 ...
 * @version $Revision$
 */
public class CopyOfItem extends DSpaceObject
{
    /**
    ...
    /** log4j category */
    private static final Logger log = Logger.getLogger(CopyOfItem.class);
     ...
     * @throws SQLException
     */
    CopyOfItem(Context context, TableRow row) throws SQLException
    {
        super(context);
     ...
     * @throws SQLException
     */
    public static CopyOfItem find(Context context, int id) throws SQLException
    {
        // First check the cache
        CopyOfItem fromCache = (CopyOfItem) context.fromCache(CopyOfItem.class, id);
        ...
        return new CopyOfItem(context, row);
    }
     ...
     */
    static CopyOfItem create(Context context) throws SQLException, AuthorizeException
    {
        TableRow row = DatabaseManager.create(context, "item");
        CopyOfItem i = new CopyOfItem(context, row);
    ...
    public static ItemIterator findByMetadataFieldAuthority(Context context, String mdString, String authority) throws SQLException, AuthorizeException, IOException {
        ...
        if (CopyOfItem.ANY.equals(authority)) {
...
//               Remove from indices
     ...
     */
     ...
     public boolean equals(Object obj)
     {
         ...
         final CopyOfItem other = (CopyOfItem) obj;
    ...
    {
        return getMetadataFirstValue(MetadataSchema.DC_SCHEMA, "title", null, CopyOfItem.ANY);
    }
          ...
          throws SQLException, AuthorizeException, IOException
    {
        ...
        TableRowIterator rows = null;
        if (CopyOfItem.ANY.equals(value))
        {
