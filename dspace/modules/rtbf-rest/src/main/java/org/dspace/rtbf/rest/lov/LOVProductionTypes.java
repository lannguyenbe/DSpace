...
public class LOVProductionTypes extends Resource {
    private static Logger log = Logger.getLogger(LOVProductionTypes.class);
    
    public static final String FACETFIELD = "production_type";
    ...
    throws WebApplicationException
    {
        ...
        if (partialTerms.isEmpty()) {
    		...
    		log.info("Reading all productions types.");
