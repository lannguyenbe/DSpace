...
public class Community extends DSpaceObject
{
    ...
    // Lan 22.04.2015 - Add maxRownum param to limit number of rows to retrieve
    public Collection[] getCollections(int maxRownum) throws SQLException
    {
    	if (maxRownum <= 0) { return new Collection[0]; }
    ...
    // Lan 22.04.2015 - Add maxRownum param to limit number of rows to retrieve
    public Community[] getSubcommunities(int maxRownum) throws SQLException
    {
    	if (maxRownum <= 0) { return new Community[0]; }
