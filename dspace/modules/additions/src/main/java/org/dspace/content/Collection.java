...
public class Collection extends DSpaceObject
{
    ...
    public ItemIterator getItemsOrderByDateDiffusion(Integer limit, Integer offset) throws SQLException
    {
        List<Serializable> params = new ArrayList<Serializable>();
    ...
    public ItemIterator getItemsByDateDiffusion(String sdate, Integer limit, Integer offset) throws SQLException
    {
        List<Serializable> params = new ArrayList<Serializable>();
        StringBuffer myQuery = new StringBuffer(
        		"SELECT item.* "
        		...
        		+ " WHERE c2i.collection_id = ? "
        		+ " AND diff.event_date = to_date(?, 'YYYY-MM-DD')"
