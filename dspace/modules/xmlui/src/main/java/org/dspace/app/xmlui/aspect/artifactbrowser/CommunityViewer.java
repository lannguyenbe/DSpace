...
public class CommunityViewer extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    /* Lan 22.04.2015 - Limit the max subcommunities or collections to retrieve */
    private static int MAX_ROWNUM_CC = 1000;
    ...
    public SourceValidity getValidity() 
    {
        if (this.validity == null)
    	{
	        ...
	        try {
	            ...
	            Community[] subCommunities = community.getSubcommunities(MAX_ROWNUM_CC);
	            Collection[] collections = community.getCollections(MAX_ROWNUM_CC);
	            // Sub communities
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        // Set up the major variables
        Community community = (Community) dso;
        // Lan 22.04.2015 - specify MAX_ROWNUM_CC while getting from the DB
        Community[] subCommunities = community.getSubcommunities(MAX_ROWNUM_CC);
        Collection[] collections = community.getCollections(MAX_ROWNUM_CC);
