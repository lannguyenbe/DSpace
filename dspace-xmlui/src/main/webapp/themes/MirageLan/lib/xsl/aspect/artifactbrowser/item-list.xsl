    ...
    <xsl:template match="dim:dim" mode="itemSummaryList-DIM-metadata">
        ...
        <div class="artifact-description">
            ...
            <div class="artifact-info">
                ...
                <xsl:text> </xsl:text>
                <!-- Lan : add provenance -->
                <xsl:if test="dim:field[@element='date' and @qualifier='issued'] or dim:field[@element='publisher' or @element='provenance']">
	                <span class="publisher-date">
	                    <xsl:text>(</xsl:text>
	                    <xsl:if test="dim:field[@element='publisher' or @element='provenance']">
	                        <span class="publisher">
	                            <xsl:copy-of select="dim:field[@element='publisher']/node()"/>
	                            <xsl:value-of select="substring-before(dim:field[@element='provenance'],' sequence_id')"/>
	                        </span>
	                        <xsl:text>, </xsl:text>
	                    </xsl:if>
	                    <span class="date">
