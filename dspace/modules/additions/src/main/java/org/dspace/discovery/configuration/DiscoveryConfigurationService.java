...
public class DiscoveryConfigurationService {
    ...
    private Map<Integer, List<String>> toCatchAllMetadataFields = new HashMap<>(); /* add by Lan 25.07.2016 */
    ...
    public Map<Integer, List<String>> getToCatchAllMetadataFields() {
        return toCatchAllMetadataFields;
    }
    ...
    public void setToCatchAllMetadataFields(Map<Integer, List<String>> toCatchAllMetadataFields) {
        this.toCatchAllMetadataFields = toCatchAllMetadataFields;
    }
