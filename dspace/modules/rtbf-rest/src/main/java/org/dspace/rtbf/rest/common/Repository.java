...
public class Repository extends DSpaceObject{
    private static Logger log = Logger.getLogger(Repository.class);

    //Exandable relationships
    private Bitstream logo;

    private Repository parentCommunity;

    private String copyrightText, introductoryText, shortDescription, sidebarText;
    private Integer countItems;

    private List<Repository> subcommunities = new ArrayList<Repository>();

    private List<Collection> collections = new ArrayList<Collection>();

    public Repository(){}

    public Repository(org.dspace.content.Community community, String expand, Context context) throws SQLException, WebApplicationException{
        super(community);
    ...
    private void setup(org.dspace.content.Community community, String expand, Context context) throws SQLException{
        ...
        if(expandFields.contains("parentCommunity") || expandFields.contains("all")) {
            ...
            if(parentCommunity != null) {
                setParentCommunity(new Repository(parentCommunity, null, context));
            }
        } else {
        ...
        if(expandFields.contains("subCommunities") || expandFields.contains("all")) {
            ...
            subcommunities = new ArrayList<Repository>();
            for(org.dspace.content.Community subCommunity : communityArray) {
                if(AuthorizeManager.authorizeActionBoolean(context, subCommunity, org.dspace.core.Constants.READ)) {
                	subcommunities.add(new Repository(subCommunity, null, context));
                } else {
    ...
    public Repository getParentCommunity() {
        return parentCommunity;
    }

    public void setParentCommunity(Repository parentCommunity) {
	...
	public List<Repository> getSubcommunities() {
		return subcommunities;
	}
	
	public void setSubcommunities(List<Repository> subcommunities) {
