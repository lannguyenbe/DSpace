...
//               Remove from indices
    ...
    /* Lan 27.05.2016 : add getItemRow() in protected
     * to be able to contruct instance of subclass ItemAdd from Item instance; then casting to Item to access Item method
     *    ItemAdd myItemWithNewFeatures = new ItemAdd(item);
     *    myItemWithNewFeatures.newFeature(); // call to new feature
     *    (Item) myItemWithNewFeatures.originalFeature() // call to original method from Item from DSpace
     */
    protected TableRow getItemRow() {
    	return(this.itemRow);
    }
}
